 ...
 * @author speralta
 */
public class ConjunctionPropertySelectorsBuilder<FROM, PARENT extends Serializable> extends AbstractBuilder<FROM> {
    ...
    public ConjunctionPropertySelectorsBuilder(SearchParameters<FROM> searchParameters, PARENT parent) {
