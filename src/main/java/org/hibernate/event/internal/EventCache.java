 ...
 *
 * Copyright (c) 20.8.3-SNAPSHOT011, Red Hat Inc. or third-party contributors as
 ...
 *
 * HACK to work around this "fix":
 * <ul>
 * <li>https://hibernate.atlassian.net/browse/HHH-6848</li>
 * <li>https://github.com/hibernate/hibernate-orm/pull/208</li>
 * </ul>
 * 
 * @author Gail Badner
 */
class EventCache implements Map {
    ...
    private final Map<Object, Object> entityToCopyMap = new IdentityHashMap<Object, Object>(10);
    ...
    private final Map<Object, Object> copyToEntityMap = new IdentityHashMap<Object, Object>(10);
    // maintains the inverse of the entityToCopyMap for performance reasons.

    private final Map<Object, Boolean> entityToOperatedOnFlagMap = new IdentityHashMap<Object, Boolean>(10);

    // key is an entity involved with the operation performed by the listener;
    // value is a flag indicating if the listener explicitly operates on the
    // entity
    ...
    /**
     * Returns true if this EventCache contains a mapping for the specified
     * entity.
     * 
     * @param entity
     *            must be non-null
     * @return true if this EventCache contains a mapping for the specified
     *         entity
    ...
    /**
     * Returns an unmodifiable set view of the entity-to-copy mappings contained
     * in this EventCache.
     * 
     * @return an unmodifiable set view of the entity-to-copy mappings contained
     *         in this EventCache
     * 
    ...
    /**
     * Returns an unmodifiable set view of the entities contained in this
     * EventCache
     * 
     * @return an unmodifiable set view of the entities contained in this
     *         EventCache
     * 
     * @see {@link Collections#unmodifiableSet(java.util.Set)}
     */
    ...
    /**
     * Associates the specified entity with the specified copy in this
     * EventCache;
     * 
     * @param entity
     *            must be non-null
     * @param copy
     *            must be non- null and must not be associated with any other
     *            entity in this EntityCache.
     * @return previous copy associated with specified entity, or null if there
     *         was no mapping for entity.
     * @throws NullPointerException
     *             if entity or copy is null
     * @throws IllegalStateException
     *             if the specified copy is already associated with a different
     *             entity.
     */
    @Override
     ...
     * @throws NullPointerException
     *             if any map keys or values are null
     */
    @Override
     ...
     * @param entity
     *            must be non-null
     * @return previous value associated with specified entity, or null if there
     *         was no mapping for entity.
     * @throws NullPointerException
     *             if entity is null
     */
    ...
    /**
     * Returns an unmodifiable set view of the entity copies contained in this
     * EventCache.
     * 
     * @return an unmodifiable set view of the entity copies contained in this
     *         EventCache
     * 
     * @see {@link Collections#unmodifiableSet(java.util.Set)}
     */
    ...
    /**
     * Returns true if the listener is performing the operation on the specified
     * entity.
     * 
     * @param entity
     *            must be non-null
     * @return true if the listener is performing the operation on the specified
     *         entity.
     * @throws NullPointerException
     *             if entity is null
     */
    ...
    /**
     * Set flag to indicate if the listener is performing the operation on the
     * specified entity.
     * 
     * @param entity
     *            must be non-null and this EventCache must contain a mapping
     *            for this entity
     * @throws NullPointerException
     *             if entity is null
     * @throws AssertionFailure
     *             if this EventCache does not contain a mapping for the
     *             specified entity
     */
    ...
    private String printEntity(Object entity) {
        ...
        // Entity was not found in current persistence context. Use
