...
var BookingReportsPage = function() {
  ...
  this.firstLine = element(by.xpath('//body/div[2]//nav/ul[@class="nav nav-pills nav-stacked"]/li[1]/a'));
  this.secondLine = element(by.xpath('//body/div[2]//nav/ul[@class="nav nav-pills nav-stacked"]/li[2]/a'));
