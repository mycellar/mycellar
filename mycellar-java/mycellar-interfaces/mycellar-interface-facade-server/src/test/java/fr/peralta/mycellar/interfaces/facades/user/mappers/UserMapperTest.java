...
public class UserMapperTest extends
        AbstractMapperTest<fr.peralta.mycellar.interfaces.facades.user.User, User, UserMapper> {
     ...
     */
    @Override
    protected UserMapper createObjectToTest() {
    ...
    protected void fillTestValues(
            List<TestValue<fr.peralta.mycellar.interfaces.facades.user.User, User>> testValues) {
        fr.peralta.mycellar.interfaces.facades.user.User input = new fr.peralta.mycellar.interfaces.facades.user.User();
        input.setEmail("email");
        input.setFirstname("firstname");
        input.setLastname("lastname");
        input.setPassword("password");

        User expected = new User("email", "password", "firstname", "lastname");

        testValues.add(new TestValue<fr.peralta.mycellar.interfaces.facades.user.User, User>(input,
                expected));
    }
