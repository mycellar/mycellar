 ...
 */
@Service
public class DrinkBottlesPageDescriptor extends AbstractDescriptor implements
        IMenuDescriptor<CellarSuperPage, DrinkBottlesPage> {

    /**
     * {@inheritDoc}
     */
    @Override
    public Class<DrinkBottlesPage> getMenuableClass() {
        return DrinkBottlesPage.class;
    }
