 ...
 * @author speralta
 */
public class AppellationMultiplePanel extends MultiplePanel<Appellation> {
     ...
     * @param count
     */
    public AppellationMultiplePanel(String id, IModel<SearchForm> searchFormModel, CountEnum count) {
        super(id);
     ...
     */
    @Override
    protected Map<Appellation, Long> getData() {
        return wineServiceFacade.getAppellations(searchFormModel.getObject(), count);
    }
