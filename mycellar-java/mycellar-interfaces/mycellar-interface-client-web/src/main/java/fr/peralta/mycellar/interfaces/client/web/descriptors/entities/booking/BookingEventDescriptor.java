...
import fr.peralta.mycellar.interfaces.client.web.pages.admin.booking.BookingEventsPage;

/**
 * @author speralta
 */
@Component
public class BookingEventDescriptor extends AbstractDescriptor implements
        IEntityDescriptor<BookingEvent, BookingEventsPage> {

    /**
     * {@inheritDoc}
     */
    @Override
    public Class<BookingEventsPage> getListPageClass() {
