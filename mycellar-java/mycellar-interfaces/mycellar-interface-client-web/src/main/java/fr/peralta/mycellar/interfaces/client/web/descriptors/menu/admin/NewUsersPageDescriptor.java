 ...
 */
@Component
public class NewUsersPageDescriptor extends AbstractDescriptor implements
        IMenuDescriptor<NewUsersPage> {

    /**
     * {@inheritDoc}
     */
    @Override
    public Class<NewUsersPage> getMenuableClass() {
        return NewUsersPage.class;
    }
