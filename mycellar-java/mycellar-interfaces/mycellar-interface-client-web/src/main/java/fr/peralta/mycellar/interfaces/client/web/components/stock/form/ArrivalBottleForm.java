 ...
 * @author speralta
 */
public class ArrivalBottleForm extends ObjectForm<ArrivalBottle> {

    private static final long serialVersionUID = 201205101119L;
     ...
     * @param newObject
     */
    public ArrivalBottleForm(String id, IModel<SearchForm> searchFormModel, ArrivalBottle newObject) {
     ...
     * @param searchFormModel
     */
    public ArrivalBottleForm(String id, IModel<SearchForm> searchFormModel) {
    ...
    protected Component createEditPanel(String id, IModel<SearchForm> searchFormModel) {
        return new ArrivalBottleEditPanel(id, searchFormModel);
    }
