 ...
 * @author speralta
 */
public class FormatMultiplePanel extends MultiplePanel<Format> {
     ...
     * @param count
     */
    public FormatMultiplePanel(String id, IModel<SearchForm> searchFormModel, CountEnum count) {
        super(id);
     ...
     */
    @Override
    protected Map<Format, Long> getData() {
