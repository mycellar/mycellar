 ...
 */
@Component
public class BookingEventsPageDescriptor extends AbstractDescriptor implements
        IMenuDescriptor<BookingEventsPage> {

    /**
     * {@inheritDoc}
     */
    @Override
    public Class<BookingEventsPage> getMenuableClass() {
