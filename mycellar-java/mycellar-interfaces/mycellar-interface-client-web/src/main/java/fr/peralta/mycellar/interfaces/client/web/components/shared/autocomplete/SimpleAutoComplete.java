 ...
 * @param <O>
 */
public abstract class SimpleAutoComplete<O extends IdentifiedEntity<O>> extends SimpleComponent<O>
        implements ObjectAutoCompleteSelectionChangeListener<Integer> {
     ...
     * @param label
     */
    public SimpleAutoComplete(String id, IModel<String> label) {
        super(id, label);
    }
