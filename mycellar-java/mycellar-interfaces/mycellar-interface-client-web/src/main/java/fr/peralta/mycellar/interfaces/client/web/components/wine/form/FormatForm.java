 ...
 * @author speralta
 */
public class FormatForm extends ObjectForm<Format> {
     ...
     * @param newObject
     */
    public FormatForm(String id, IModel<SearchForm> searchFormModel, Format newObject) {
     ...
     * @param searchFormModel
     */
    public FormatForm(String id, IModel<SearchForm> searchFormModel) {
