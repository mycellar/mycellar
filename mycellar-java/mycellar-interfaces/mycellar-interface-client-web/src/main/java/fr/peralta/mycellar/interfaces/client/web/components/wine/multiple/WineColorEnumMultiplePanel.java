 ...
 * @author speralta
 */
public class WineColorEnumMultiplePanel extends MultiplePanel<WineColorEnum> {
     ...
     * @param count
     */
    public WineColorEnumMultiplePanel(String id, IModel<SearchForm> searchFormModel, CountEnum count) {
        super(id);
     ...
     */
    @Override
    protected Map<WineColorEnum, Long> getData() {
        return wineServiceFacade.getColors(searchFormModel.getObject(), count);
    }
