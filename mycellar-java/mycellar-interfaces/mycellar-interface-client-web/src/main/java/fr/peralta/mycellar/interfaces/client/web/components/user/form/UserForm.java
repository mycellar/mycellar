 ...
 * @author speralta
 */
public class UserForm extends ObjectForm<User> {

    private static final long serialVersionUID = 201205101335L;
     ...
     * @param newObject
     */
    public UserForm(String id, IModel<SearchForm> searchFormModel, User newObject) {
     ...
     * @param searchFormModel
     */
    public UserForm(String id, IModel<SearchForm> searchFormModel) {
