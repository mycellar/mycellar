 ...
 */
package fr.peralta.mycellar.interfaces.client.web.descriptors.entities.contact;
 ...
 */
@Component
public class ContactDescriptor extends AbstractDescriptor implements
        IEntityDescriptor<Contact, ContactsPage> {

    /**
     * {@inheritDoc}
     */
    @Override
    public Class<ContactsPage> getListPageClass() {
