 ...
 * @author speralta
 */
public class CellarShareDataProvider extends
        MultipleSortableDataProvider<CellarShare, CellarShareOrderEnum, CellarShareOrder> {
     ...
     */
    public CellarShareDataProvider(IModel<SearchForm> searchFormModel) {
        super(new CellarShareOrder());
     ...
     */
    @Override
    public Iterator<? extends CellarShare> iterator(int first, int count) {
        return stockServiceFacade.getCellarShares(searchFormModel.getObject(),
    ...
    @Override
    public int size() {
        return (int) stockServiceFacade.countCellarShares(searchFormModel.getObject());
    }
     ...
     */
    @Override
    public IModel<CellarShare> model(CellarShare object) {
        return new Model<CellarShare>(object);
    }
