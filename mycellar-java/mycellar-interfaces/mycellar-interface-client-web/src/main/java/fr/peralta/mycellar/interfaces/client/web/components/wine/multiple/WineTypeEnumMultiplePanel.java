 ...
 * @author speralta
 */
public class WineTypeEnumMultiplePanel extends MultiplePanel<WineTypeEnum> {
     ...
     * @param count
     */
    public WineTypeEnumMultiplePanel(String id, IModel<SearchForm> searchFormModel, CountEnum count) {
        super(id);
     ...
     */
    @Override
    protected Map<WineTypeEnum, Long> getData() {
        return wineServiceFacade.getTypes(searchFormModel.getObject(), count);
    }
