 ...
 */
@Component
public class NewVintagesPageDescriptor extends AbstractDescriptor implements
        IMenuDescriptor<NewVintagesPage> {

    /**
     * {@inheritDoc}
     */
    @Override
    public Class<NewVintagesPage> getMenuableClass() {
        return NewVintagesPage.class;
    }
