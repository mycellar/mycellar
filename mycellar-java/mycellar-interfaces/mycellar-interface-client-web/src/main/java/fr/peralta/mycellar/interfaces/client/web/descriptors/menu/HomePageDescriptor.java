 ...
 */
@Service
public class HomePageDescriptor extends AbstractDescriptor implements
        IMenuDescriptor<HomeSuperPage, HomePage> {
     ...
     */
    @Override
    public Class<HomeSuperPage> getSuperClass() {
        return HomeSuperPage.class;
    }
