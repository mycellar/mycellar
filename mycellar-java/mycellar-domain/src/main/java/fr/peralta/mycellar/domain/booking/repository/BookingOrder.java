 ...
 * @author speralta
 */
public class BookingOrder extends AbstractEntityOrder<BookingOrderEnum, BookingOrder> {
     ...
     */
    @Override
    public BookingOrderEnum getFrom(String property) {
        return BookingOrderEnum.valueOf(property);
    }
