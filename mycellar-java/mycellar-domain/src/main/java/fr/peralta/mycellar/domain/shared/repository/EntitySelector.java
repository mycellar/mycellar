 ...
 */
public class EntitySelector<E, T extends Identifiable<TPK>, TPK extends Serializable> implements
        Serializable {
    ...
    public static <E2, T2 extends Identifiable<TPK2>, TPK2 extends Serializable> EntitySelector<E2, T2, TPK2> newEntitySelector(
            SingularAttribute<E2, T2> field) {
        return new EntitySelector<>(field);
    }
    ...
    public static <E2, T2 extends Identifiable<TPK2>, TPK2 extends Serializable> EntitySelector<E2, T2, TPK2> newEntitySelector(
        ...
        EntitySelector<E2, T2, TPK2> entitySelector = new EntitySelector<>(field);
        entitySelector.setSelected(selected);
        return entitySelector;
    }

    /**
     * Import statically this helper for smooth instantiation. It is used in the
