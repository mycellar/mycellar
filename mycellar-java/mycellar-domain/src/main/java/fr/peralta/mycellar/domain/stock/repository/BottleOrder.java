 ...
 * @author speralta
 */
public class BottleOrder extends AbstractEntityOrder<BottleOrderEnum, BottleOrder> {
     ...
     */
    @Override
    public BottleOrderEnum getFrom(String property) {
        return BottleOrderEnum.valueOf(property);
    }
