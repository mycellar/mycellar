 ...
 * @author speralta
 */
public class ContactOrder extends AbstractEntityOrder<ContactOrderEnum, ContactOrder> {
     ...
     */
    @Override
    public ContactOrderEnum getFrom(String property) {
        return ContactOrderEnum.valueOf(property);
    }
