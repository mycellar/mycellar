 ...
 * @author speralta
 */
public class CellarOrder extends AbstractEntityOrder<CellarOrderEnum, CellarOrder> {
     ...
     */
    @Override
    public CellarOrderEnum getFrom(String property) {
        return CellarOrderEnum.valueOf(property);
    }
