 ...
 * @author speralta
 */
public class ProducerOrder extends AbstractEntityOrder<ProducerOrderEnum, ProducerOrder> {
     ...
     */
    @Override
    public ProducerOrderEnum getFrom(String property) {
        return ProducerOrderEnum.valueOf(property);
    }
