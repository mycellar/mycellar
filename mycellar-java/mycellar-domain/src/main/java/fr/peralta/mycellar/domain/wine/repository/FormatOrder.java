 ...
 * @author speralta
 */
public class FormatOrder extends AbstractEntityOrder<FormatOrderEnum, FormatOrder> {
     ...
     */
    @Override
    public FormatOrderEnum getFrom(String property) {
        return FormatOrderEnum.valueOf(property);
    }
